 ...
 */
public class RTLinearLayout extends LinearLayout {
    public RTLinearLayout(Context context) {
        super(context);
    }

    public RTLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RTLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    public CharSequence getAccessibilityClassName() {
        return RTLinearLayout.class.getName();
    }
