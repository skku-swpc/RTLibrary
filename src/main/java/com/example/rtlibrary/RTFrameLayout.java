 ...
 */
public class RTFrameLayout extends FrameLayout {

    public RTFrameLayout(Context context) {
        super(context);
    }

    public RTFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RTFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    public CharSequence getAccessibilityClassName() {
        return RTFrameLayout.class.getName();
    }
