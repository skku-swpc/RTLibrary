 ...
 */
public class RTRelativeLayout extends RelativeLayout {

    public RTRelativeLayout(Context context) {
        super(context);
    }

    public RTRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RTRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    public CharSequence getAccessibilityClassName() {
        return RTRelativeLayout.class.getName();
    }
