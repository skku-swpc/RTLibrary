 ...
 */
public class RTCheckBox extends CheckBox {
    public RTCheckBox(Context context) {
        super(context);
    }

    public RTCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RTCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    public CharSequence getAccessibilityClassName() {
        return RTCheckBox.class.getName();
    }
