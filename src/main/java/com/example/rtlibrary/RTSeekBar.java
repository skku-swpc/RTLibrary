 ...
 */
public class RTSeekBar extends SeekBar {
    public RTSeekBar(Context context) {
        super(context);
    }

    public RTSeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RTSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }
    public CharSequence getAccessibilityClassName() {
        return RTSeekBar.class.getName();
    }
